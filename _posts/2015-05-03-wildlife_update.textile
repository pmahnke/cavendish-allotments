...
<!-- Comments -->
<ul>
{% for 2015-05-03-wildlife_update in site.data.2015-05-03-wildlife_update %}
  <li>

    {{ 2015-05-03-wildlife_update.comment }}

    <cite>{{ 2015-05-03-wildlife_update.author }} on {{ 2015-05-03-wildlife_update.date }}</cite>
